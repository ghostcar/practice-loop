...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("schema_version", sa.Integer, nullable=False),
        sa.Column("canonical_config", postgresql.JSONB, nullable=False),
        sa.Column("config_sha256", sa.String(64), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("late_close_policy", postgresql.JSONB, nullable=True),
        sa.Column("llm_flags", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("schema_version", sa.Integer, nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    op.create_check_constraint(
    ...
    op.create_table(
        ...
        sa.Column("media_policy", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("verification_policy", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("penalty_policy", postgresql.JSONB, nullable=True),
        sa.Column("availability_policy", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("llm_flags", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("schema_version", sa.Integer, nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("occurrence_snapshot", postgresql.JSONB, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("penalty_metadata", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
