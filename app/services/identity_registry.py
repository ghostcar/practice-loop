...
DEFAULT_STATUS_TAGS: dict[str, list[dict[str, str]]] = {
    "permanent": [
        ...
        {"tag": "pathetic_loser", "title_ru": "Хронический неудачник", "title_en": "Pathetic Loser"},
    ],
    "standing": [
        {"tag": "chastity_locked", "title_ru": "Заперт в поясе", "title_en": "Chastity Locked"},
        {"tag": "in_lock_cycle", "title_ru": "В цикле ношения", "title_en": "In Lock Cycle"},
        {"tag": "frozen_timer", "title_ru": "Время заморожено", "title_en": "Timer Frozen"},
        {"tag": "pilloried", "title_ru": "На позорном столбе", "title_en": "Pilloried"},
        {"tag": "loser", "title_ru": "Неудачник фортуны", "title_en": "Unfortunate Loser"},
    ...
    "dynamic": [
        {"tag": "unlucky", "title_ru": "Полоса неудач", "title_en": "Unlucky Streak"},
        {"tag": "thawed", "title_ru": "Оттаявший", "title_en": "Thawed"},
        {"tag": "under_trial", "title_ru": "Под испытанием", "title_en": "Under Trial"},
        {"tag": "obedient", "title_ru": "Покорный", "title_en": "Obedient"},
        {"tag": "disobedient", "title_ru": "Строптивый", "title_en": "Disobedient"},
        {"tag": "lock_survived", "title_ru": "Выдержал замок", "title_en": "Lock Survived"},
        {"tag": "broken_lock", "title_ru": "Сорванный замок", "title_en": "Broken Lock"},
