...
«Объём груди» → chest impact). Оставшиеся непривязанные (5 названий) — однословные кинк-термины
(«Упаковка», «Питьё», «ЗД», «Опорожнение», «Уборка»), слишком общие для автоматического матчинга;
они остаются в данных, но не загрязняют синонимы.
