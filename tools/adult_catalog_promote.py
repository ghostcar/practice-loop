...
SPECS: dict[str, dict[str, Any]] = {
    ...
    "category-chat-002": dict(
        slug="pre-session-bowel-holding",
        ru="Воздержание от опорожнения перед сессией", en="Pre-session bowel holding",
        kind="preparation",
        summary_ru="Согласованное воздержание от опорожнения в заданный период до сессии.",
        summary_en="Agreed bowel-holding window before a session.",
    ),
    "category-chat-004": dict(
        slug="basic-urine-retention",
        ru="Накопление мочи (базовое)", en="Basic urine retention",
        kind="activity",
    ...
    "category-chat-005": dict(
        ...
        ru="Удержание мочи с контролем предела", en="Controlled urine holding",
        kind="activity",
    ...
    "category-chat-006": dict(
        slug="controlled-urine-release",
        ru="Контролируемый сброс мочи", en="Controlled urine release",
        kind="activity",
        summary_ru="Осознанный контролируемый сброс накопленной мочи по согласованному сценарию.",
        summary_en="Conscious controlled release of retained urine.",
    ),
    ...
    "category-chat-017": dict(
        slug="ice-water-enema",
        ru="Клизма с ледяной водой", en="Ice-water enema",
        kind="activity",
    ...
    "category-chat-019": dict(
        slug="combined-retention-block",
        ru="Комбинированный блок удержания", en="Combined retention block",
        kind="activity",
    ...
    "category-chat-022": dict(
        ...
        ru="Накопление каловых масс", en="Fecal retention",
        kind="activity",
        summary_ru="Контролируемое накопление каловых масс до согласованного момента с гигиеническими мерами.",
        summary_en="Controlled fecal retention up to an agreed point, with hygiene measures.",
    ),
    "category-chat-024": dict(
        slug="bowel-urge-control",
        ru="Контроль позывов", en="Bowel urge control",
        kind="activity",
    ...
    "category-chat-025": dict(
        ...
        ru="Удержание с контролем позыва", en="Controlled urge holding",
        kind="activity",
    ...
    "category-chat-026": dict(
        ...
        ru="Удержание в фиксации", en="Holding in bondage",
        kind="activity",
    ...
    "category-chat-029": dict(
        slug="body-release-play",
        ru="Выпуск на тело", en="Body release play",
        kind="activity",
        summary_ru="Выпуск на собственное тело в согласованной обстановке с гигиенической подготовкой.",
        summary_en="Release onto one's own body, agreed and hygienically prepared.",
    ),
    "category-chat-031": dict(
        slug="smearing-play",
        ru="Размазывание на теле", en="Smearing play",
        kind="reference",
    ...
    "category-chat-032": dict(
        ...
        ru="Оральное использование (без проглатывания)", en="Oral use (no swallowing)",
        kind="reference",
        summary_ru="Справочная карточка: оральное использование без проглатывания; исполняемая инструкция не предоставляется.",
        summary_en="Reference card: oral use without swallowing; no executable instruction.",
    ),
    "category-chat-033": dict(
        slug="oral-use-swallowing",
        ru="Оральное использование (с проглатыванием)", en="Oral use (swallowing)",
        kind="reference",
        summary_ru="Справочная карточка: оральное использование с проглатыванием; исполняемая инструкция не предоставляется.",
        summary_en="Reference card: oral use with swallowing; no executable instruction.",
    ),
    "category-chat-034": dict(
        slug="feeding-with-mashing",
        ru="Кормление с уминанием", en="Feeding with mashing",
        kind="reference",
    ...
    "category-chat-037": dict(
        ...
        ru="Длительный контроль дефекации", en="Extended bowel control",
        kind="activity",
    ...
    "category-chat-041": dict(
        ...
        ru="Смешанный блок контроля", en="Mixed control block",
        kind="activity",
    ...
    "category-chat-053": dict(slug="water-immersion-breathplay", ru="Водное ограничение (лицо в воде)", en="Water immersion breathplay", kind="reference",
    ...
    "category-chat-127": dict(
        slug="wax-dripping", ru="Капание воском", en="Wax dripping",
        kind="reference",
        summary_ru="Справочная карточка: капание воском; исполняемая инструкция не предоставляется.",
        summary_en="Reference card: wax dripping; no executable instruction.",
    ),
    "category-chat-128": dict(
        slug="wax-trail", ru="Восковая дорожка", en="Wax trail",
        kind="reference",
        summary_ru="Справочная карточка: восковая дорожка; исполняемая инструкция не предоставляется.",
        summary_en="Reference card: wax trail; no executable instruction.",
    ),
