...
ICONS: dict[str, str] = {
    ...
    "cup": '<path d="M4 8h13v7a5 5 0 01-5 5H9a5 5 0 01-5-5z"/><path d="M17 9h2a2.5 2.5 0 010 5h-2"/><path d="M7.5 5.5c0-1 .8-1.5.8-2.5m3.4 2.5c0-1 .8-1.5.8-2.5"/>',
    ...
    "gift": '<rect x="3" y="8" width="18" height="4"/><path d="M5 12v9h14v-9M12 8v13"/><path d="M12 8c-2.5 0-4.5-1.5-4.5-3.5S9.5 2 11 3.5L12 8zm0 0c2.5 0 4.5-1.5 4.5-3.5S14.5 2 13 3.5L12 8z"/>',
    ...
    "heat": '<path d="M12 4c1.6 2.6 4.8 4.6 4.8 8.4a4.8 4.8 0 01-9.6 0C7.2 8.6 10.4 6.6 12 4z"/><path d="M12 13.5a2 2 0 002-2c0-1-.6-1.8-1.2-2.5-.1 1-.7 1.5-1.3 1.8-.1-1.3-.4-2.5.5-3.8"/><path d="M7 2v2m10-2v2M2 7h2m16 0h2M4.5 4.5l1.5 1.5m12-1.5L16.5 6.5"/>',
    ...
    "journal": '<path d="M5 4h11a3 3 0 013 3v13H5a2 2 0 01-2-2V6a2 2 0 012-2z"/><path d="M8 8h6M8 12h6M8 16h4"/><path d="M19 7v13a2 2 0 002 2"/>',
    ...
    "shield-check": '<path d="M12 3l8 4v5c0 4.5-3 7.5-8 9-5-1.5-8-4.5-8-9V7z"/><path d="M8.5 12.5l2.5 2.5 5-6"/>',
    "skip": '<path d="M5 5l10 7L5 19zM19 5v14"/>',
    "sliders": '<path d="M4 7h9m-3 10h10M4 17h4M16 7h4"/><circle cx="13" cy="7" r="2"/><circle cx="7" cy="17" r="2"/>',
    ...
    "rocket": '<path d="M12 3c3 2.2 4.5 5.2 4.5 8.5L20 14l-2 2-3.5-1.5c-.8 2-1.4 3.8-2.5 5.5-1.1-1.7-1.7-3.5-2.5-5.5L6 16l-2-2 3.5-2.5C7.5 8.2 9 5.2 12 3z"/><circle cx="12" cy="9.5" r="1.5"/><path d="M9 19l-1 2M15 19l1 2"/>',
    "tools": '<path d="M15 4a5 5 0 00-4.6 7L4 17.4V21h3.6L14 14.6A5 5 0 0015 4z"/><path d="M17.5 2.5l4 4"/>',
    "lotion": '<rect x="8" y="10" width="8" height="11" rx="2"/><path d="M10 10V6h4v4M12 6V3.5"/><path d="M8 15h8"/>',
    "dice": '<rect x="5" y="5" width="14" height="14" rx="3"/><circle cx="9" cy="9" r=".9" fill="currentColor" stroke="none"/><circle cx="15" cy="9" r=".9" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r=".9" fill="currentColor" stroke="none"/><circle cx="9" cy="15" r=".9" fill="currentColor" stroke="none"/><circle cx="15" cy="15" r=".9" fill="currentColor" stroke="none"/>',
    "droplet": '<path d="M12 3c3.5 4.4 6 7.7 6 11a6 6 0 01-12 0c0-3.3 2.5-6.6 6-11z"/><path d="M9 14.5a3 3 0 003 3"/>',
    ...
    "crown": '<path d="M4 18l-1-8 5 3.5L12 6l4 7.5L21 10l-1 8z"/><path d="M4 18v3h16v-3"/>',
    "target": '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1.5"/><path d="M12 3v2m0 14v2M3 12h2m14 0h2"/>',
    "flame": '<path d="M12 3c1.5 2.5 4.5 4.4 4.5 8a4.5 4.5 0 01-9 0c0-1.8.8-3.2 1.8-4.4.2 1.6 1.1 2.5 1.9 2.9.1-2.3-.2-4.6 1-6.5z"/><path d="M12 15a2 2 0 002-2c0-1-.6-1.8-1.2-2.5-.1 1-.7 1.5-1.3 1.8-.1-1.3-.4-2.5.5-3.8"/>',
    ...
    "star": '<path d="M12 3l2.2 5.3 5.8.6-4.3 3.9 1.2 5.7L12 15.7 7.1 18.5l1.2-5.7L4 8.9l5.8-.6z"/>',
    ...
    "volume": '<path d="M4 9h4l5-4v14l-5-4H4z"/><path d="M16 9.5a4 4 0 010 5M18.5 7a7.5 7.5 0 010 10"/>',
    "printer": '<path d="M7 3h10v5H7zM6 8h12a3 3 0 013 3v5h-4v5H7v-5H3v-5a3 3 0 013-3z"/><path d="M8 17h8M8 14h8"/>',
    "vote": '<path d="M5 10h14v11H5zM8 10l4-7 4 7M8 15h8"/>',
    "warning": '<path d="M12 3L2.5 20h19z"/><path d="M12 9v5m0 3h.01"/>',
    "thumbs-up": '<path d="M7 11v8a2 2 0 002 2h8.5a2 2 0 002-1.8l1.2-8a2 2 0 00-2-2.2H15V6a3 3 0 00-6 0v1L7 11z"/><path d="M7 11H4a2 2 0 00-2 2v5a2 2 0 002 2h3"/>',
    "party": '<path d="M16 11l.5-2.5a1.5 1.5 0 011.8-1.2l.4.1a1.5 1.5 0 01.8 2.2l-3 4.5"/><path d="M8 11l-.5-2.5a1.5 1.5 0 00-1.8-1.2l-.4.1a1.5 1.5 0 00-.8 2.2l3 4.5"/><path d="M12 6l.5-2.5A1.5 1.5 0 0114.3 2l.4.1a1.5 1.5 0 01.8 2.2L14 7"/><path d="M10 7L9.5 4.5A1.5 1.5 0 007.7 3l-.4.1a1.5 1.5 0 00-.8 2.2L8 8"/><circle cx="12" cy="13" r="6"/><path d="M10.5 15l1 1 2-2"/>',
    "muscle": '<path d="M17 4l-2 5h3l-2 4h3l-3 7"/><path d="M7 20l2-5H6l2-4H5l3-7"/>',
}
