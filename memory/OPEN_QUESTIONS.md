...
| 11 | **Новая модель хранения активностей (examples/update.md → ADR-035…042)** | **запланировано (Session 58)** | Реализация по фазам: Phase 1 модель+миграция 022 (ActivityCategory + seed 16 категорий, эволюция Entity/ActivityLog/ActivitySession, activity_task_history, статус-машина 11) → Phase 2 backend (DSL параметров, title-генератор, API, LLM-адаптация, геймификация) → Phase 3 UI → Phase 4 тесты/память/деплой |
