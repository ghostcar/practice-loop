...
| 11 | **Новая модель хранения активностей (examples/update.md → ADR-035…042)** | **Phase 1 ✅ (S58)** | ✅ Phase 1: ActivityCategory + seed 16 категорий, эволюция Entity/ActivityLog/ActivitySession, activity_task_history, статус-машина 11, миграция 022 (PG15 ✅), 335/335 тестов. Осталось: Phase 2 backend (DSL параметров, title-генератор, API переходов статусов, LLM-адаптация planned/actual, геймификация по новым статусам) → Phase 3 UI → Phase 4 тесты/память/деплой |
