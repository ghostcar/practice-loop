...
Обновляется **в конце каждой сессии**. Последнее обновление: 2026-08-13 (сессия 94 — финиш по датам: locktimer + achievements + JS localDateISO; все datetime-отображения device-local).
