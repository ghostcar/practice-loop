...
Обновляется **в конце каждой сессии**. Последнее обновление: 2026-08-13 (сессия 92 — финиш по датам/времени: naive now() + exact-datetime tz).

## Общий статус: 602/602 тестов ✅, ruff ✅, format ✅
