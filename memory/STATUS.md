...
| Область | Статус |
| --- | --- |
| Проектирование (AGENT.md, tracker-spec.md, memory) | ✅ Завершено |
...
- [x] Интервью с пользователем (5 раундов): скоуп, пользователи, языки, деплой, LLM/маскирование,
      ...
      уведомления, переработка AGENT.md, подписки, сессии, бэкапы, логи LLM.
...
- [x] `AGENT.md` переработан в единый стиль (8 разделов, без Semantic Masking).
